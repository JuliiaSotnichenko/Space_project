            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="pass_port_number" class="col-md-4 col-form-label text-md-right">{{ __('pass_port_number') }}</label>

                            <div class="col-md-6">
                                <input id="pass_port_number" type="text" class="form-control @error('pass_port_number') is-invalid @enderror" name="pass_port_number" value="{{ old('pass_port_number') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control @error('country') is-invalid @enderror" name="country" value="{{ old('pass_port_number') }}" required autocomplete="name" autofocus>
