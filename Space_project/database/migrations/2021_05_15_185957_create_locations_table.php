...
class CreateLocationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('locations', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->id();
            $table->enum('lauch_location', ['Baikonur Cosmodrome', 'Kennedy Space Center', 'Guiana Space Center', 'Vikram Sarabhai Space Center', 'Tanegashima Space Center', 'Vostochny Cosmodrome', 'Boca Chica Starbase', 'Vandenberg Air Base']);
